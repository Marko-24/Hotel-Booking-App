...
import com.marko.rshotelbe.exceptions.PhotoRetrievalException;
...
public class RoomController {
    ...
    public ResponseEntity<RoomResponse> addRoom(@RequestParam("photo") MultipartFile photo,
        ...
        Room newRoom = roomService.addRoom(photo, roomType, roomPrice);
        RoomResponse response = new RoomResponse(newRoom.getRoomId(), newRoom.getRoomType(), newRoom.getRoomPrice());
    ...
    private RoomResponse getRoomResponse(Room room) {
        List<Booking> bookings = getAllBookingsByRoomId(room.getRoomId());
