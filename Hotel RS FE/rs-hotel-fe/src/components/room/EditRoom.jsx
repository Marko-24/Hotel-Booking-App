...
import { updateRoom, getRoomById } from '../utilities/APIfunctions'
  ...
  useEffect(() => {
    const fetchRoom = async () => {
      try {
        ...
        console.log("Room Data:", roomData); // Log roomData to inspect its structure
        if (roomData) {
          setRoom(roomData);
          setImagePreview(roomData.photo);
        } else {
          console.error("No room data found."); // Log error if roomData is null or undefined
        }
      } catch (error) {
        console.error("Error fetching room:", error); // Log any errors that occur during fetching
      }
    }
            ...
            <div className='col-md-8 col-lg-6'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='d-grid gap-2 d-md-flex mt-2'>
                        <Link to={"/all-rooms"} className='btn btn-outline-info ml-5'>Back</Link>
